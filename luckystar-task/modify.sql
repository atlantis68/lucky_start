ALTER TABLE `chicken_info` 
   ...
   CHANGE `login_name` `login_name` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '繁星登录名',
   CHANGE `password` `password` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '繁星登录密码', 
