		...
		try {
			...
			if(laborUnions != null) {
				for(Map<String, Object> lu : laborUnions) {
					...
					laborUnion.setLeaderEmail(lu.get("leader_email") != null ? lu.get("leader_email").toString() : "");
					laborUnion.setWorkerEmail(lu.get("worker_email") != null ? lu.get("worker_email").toString() : "");
